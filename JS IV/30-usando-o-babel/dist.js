...
var average = function average() {
  ...
  var sum = numbers.reduce(function (acum, num) {
    return acum + num;
  }, 0);
...
var weightedAverage = function weightedAverage() {
  ...
  var sum = entries.reduce(function (acum, _ref) {
    var number = _ref.number,
      weight = _ref.weight;
    return acum + number * (weight !== null && weight !== void 0 ? weight : 1);
  }, 0);
  var weightSum = entries.reduce(function (acum, entry) {
    var _entry$weight;
    return acum + ((_entry$weight = entry.weight) !== null && _entry$weight !== void 0 ? _entry$weight : 1);
  }, 0);
...
var median = function median() {
  ...
  var firstMedian = orderedNumbers[(1, _readOnlyError("middle"))];
